...
public class EventMapper {
    ...
    public static EventShortDto eventShortDto (Event event, int confirmedRequests){
        return EventShortDto.builder()
                ...
                .category(EventShortDto.CategoryDto.builder().build())
                .confirmedRequests(confirmedRequests)
                .eventDate(event.getEventDate().format(FORMATTER))
                .initiator(EventShortDto.UserShortDto.builder().build())
                .paid(event.isPaid())
    ...
    public static EventFullDto eventFullDto(Event event, int confirmedRequests){
        return EventFullDto.builder()
                .id(event.getId())
                .annotation(event.getAnnotation())
                .category(EventFullDto.CategoryDto.builder().build())
                .confirmedRequests(0)
                .createdOn(event.getCreatedOn())
                .description(event.getDescription())
                .eventDate(event.getEventDate().format(FORMATTER))
                .initiator(EventFullDto.UserShortDto.builder().build())
                .location(EventFullDto.LocationDto.builder().build())
                .paid(event.isPaid())
                .participantLimit(event.getParticipantLimit())
